...
const ContactForm = () => {
  ...
  return (
    <div className="w-full lg:w-[540px] z-10 mt-2 md:mt-0">
      <form
        action={action}
        className="mx-auto flex w-full flex-col gap-4 md:gap-8 lg:gap-10 "
      >
        ...
        <div className="grid w-full text-start items-center gap-1.5 ">
          <Label htmlFor="email" className="text-[12px] lg:text-sm font-bold ">
            Your Email
          </Label>
          <Input
            type="email"
        ...
        <div className="grid w-full text-start items-center gap-1.5 ">
          <Label htmlFor="phone" className="text-[12px] lg:text-sm font-bold ">
            Your Phone Number
          </Label>
          <Input
            type="text"
