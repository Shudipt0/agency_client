...
const ContactpageAccour = () => {
  return (
    <div className=" w-full h-full lg:h-[660px] flex flex-col lg:flex-row justify-between items-center  ">
      {/* left site */}
      <div className="lg:w-[480px] space-y-4">
        <h3 className="text-[16px] lg:text-[22px] text-blue-500 dark:text-white font-bold">
          FAQ
        </h3>
        <h1 className="text-[28px] md:text-[40px] text-black dark:text-white font-bold leading-tight">
          Here are Some Answer For Frequntly asked Questions
        </h1>
        <p className="text-[16px] lg:text-[22px] text-[#0E0E2C]/60 dark:text-white/60">
      ...
      <div className="lg:w-[540px] ">
        <Accordion type="single" collapsible className="w-full ">
          ...
          >
            <AccordionTrigger>
              Do You offer Software Development
            </AccordionTrigger>
            <AccordionContent className=" dark:text-white/60 ">
              Yes,we do offer Social Media marketing , we offer fb ads instgram
              ads ,google campagine , tiktok promotion ,and other social media
              plateforme.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem
          ...
          >
            <AccordionTrigger>
              How long it take to realise a project
            </AccordionTrigger>
            <AccordionContent className=" dark:text-white/60 ">
              Yes,we do offer Social Media marketing , we offer fb ads instgram
              ads ,google campagine , tiktok promotion ,and other social media
