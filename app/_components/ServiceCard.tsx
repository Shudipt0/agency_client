...
const ServiceCard: React.FC<ServiceCardProps> = ({ service }) => {
  return (
    <div className="md:w-[240px] md:h-[222px] flex flex-col justify-between  space-y-4">
      <h3 className="text-[22px] font-bold text-blue-600 dark:text-white leading-tight capitalize">
        {service.title}
      </h3>
      <p className="text-[16px] text-[#0E0E2C]/60 dark:text-white/80 capitalize ">
